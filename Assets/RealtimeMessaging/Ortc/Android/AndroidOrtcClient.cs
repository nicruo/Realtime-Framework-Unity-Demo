...
//  Published	: 2014
//  -------------------------------------
#if (UNITY_ANDROID && !UNITY_PRO_LICENSE)
using System;
...
namespace Realtime.Messaging.Ortc.Android
{
...
#region Events handlers (6)
        ...
        {
            SessionId = _javaObject.Call<string>("getSessionId");
...
#region ctor
        ...
        public AndroidOrtcClient()
        {
            TaskManager.RunOnMainThread(() =>
            {
                ...
                Id = _javaObject.Call<int>("getId").ToString();
            });
