...
namespace Realtime.Messaging.WebsocketsSharp
{
    ...
    public class WebSocket : IDisposable
    {
        ...
        private volatile SocketLogger _logger;
        ...
        // As server
        internal WebSocket(HttpListenerWebSocketContext context, string protocol, SocketLogger logger)
        {
            _context = context;
            _protocol = protocol;
            _logger = logger;
        ...
        // As server
        internal WebSocket(TcpListenerWebSocketContext context, string protocol, SocketLogger logger)
        {
            _context = context;
            _protocol = protocol;
            _logger = logger;
        ...
        /// </remarks>
        /// <value>
        /// A <see cref="SocketLogger"/> that provides the logging functions.
        /// </value>
        public SocketLogger Log
        {
            get
            {
                return _logger;
