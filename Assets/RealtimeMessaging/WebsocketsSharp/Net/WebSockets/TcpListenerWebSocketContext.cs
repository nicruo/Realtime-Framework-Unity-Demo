...
namespace Realtime.Messaging.WebsocketsSharp.Net.WebSockets
{
  /// <summary>
  ...
  public class TcpListenerWebSocketContext : WebSocketContext
  {
    ...
    internal TcpListenerWebSocketContext (
      TcpClient client, string protocol, bool secure, X509Certificate cert, SocketLogger logger)
    {
      _client = client;
      _secure = secure;
    ...
    /// <summary>
    /// Gets the <see cref="WebsocketsSharp.WebSocket"/> instance used for two-way communication
