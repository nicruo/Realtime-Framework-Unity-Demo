...
namespace Realtime.Messaging.WebsocketsSharp
{
  ...
  public static class Ext
  {
    ...
    private static MemoryStream decompress (this Stream stream)
    {
      ...
      stream.Position = 0;
#if UNITY_WEBPLAYER
      using (var ds = new DeflateStream(output, CompressionMode.Decompress))
      {
#else
      using (var ds = new DeflateStream (output, CompressionMode.Decompress, true)) {
#endif
    ...
    internal static TcpListenerWebSocketContext GetWebSocketContext (
      this TcpClient client, string protocol, bool secure, X509Certificate cert, SocketLogger logger)
    {
