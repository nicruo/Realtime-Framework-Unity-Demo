...
namespace Realtime.Storage.Controllers
{
    ...
    public class ItemRef<T> where T : class
    {
        ...
        public Task<StorageResponse<ItemSnapshot>> Get()
        {
            return Task.Run(() =>
              {
                  var task = _storageContext.Repository.Get<T>(_itemMeta.GetKey(Item));
        ...
        /// </summary>
        /// <returns>This item reference.</returns>
        public Task<StorageResponse<ItemSnapshot>> Set()
        {
            return Task.Run(() =>
              {

                  var task = _storageContext.Repository.Update(Item);
        ...
        /// </summary>
        /// <returns>This item reference.</returns>
        public Task<StorageResponse<ItemSnapshot>> Del()
        {
            return Task.Run(() =>
            {
                var task = _storageContext.Repository.Delete(Item);
        ...
        /// <returns>This item reference.</returns>
        public Task<StorageResponse<ItemSnapshot>> Incr(string property, int value)
        {
            return Task.Run(() =>
            {
                var task = _storageContext.Repository.Incr(Item, property, value);
        ...
        /// <param name="property">The name of the item's attribute.</param>
        /// <returns>This item reference.</returns>
        public Task<StorageResponse<ItemSnapshot>> Incr(string property)
        {
            return Task.Run(() =>
            {
                var task = _storageContext.Repository.Incr(Item, property);
        ...
        /// <param name="property">The name of the item's attribute.</param>
        /// <returns>This item reference.</returns>
        public Task<StorageResponse<ItemSnapshot>> Decr(string property)
        {
            return Task.Run(() =>
              {
                  var task = _storageContext.Repository.Decr(Item, property);
        ...
        /// <returns>This item reference.</returns>
        public Task<StorageResponse<ItemSnapshot>> Decr(string property, int value)
        {
            return Task.Run(() =>
            {
                var task = _storageContext.Repository.Decr(Item, property, value);
