...
namespace Realtime.Storage.DataAccess
{
    ...
    public class StorageRepository : IStorageRepository
    {
        ...
        {
            Init(Settings.ApplicationKey, Settings.PrivateKey, new UriPrototype
            {
        ...
        /// <returns></returns>
        Task<StorageResponse<T>> Post<T>(string operation, string body)
        {
            return Task.Run(() =>
            {
                ...
                if (EnpointUri == null)
                {
                    ...
                    if (EnpointUri == null)
                    {
                        throw new Exception("Failed to get cluster url");
                    }
                }
                ...
                task.Wait().ThrowIfFaulted();

                Log(task.Content);

                var data = JsonMapper.ToObject<StorageResponse<T>>(task.Content);
        ...
        void GetUrlFromCluster()
        {
            if (PrototypeUri.IsCluster)
            {
                ...
                var task = Client.GetAsync(request.ToString());
                ...
                var response = JsonMapper.ToObject<ClusterResponse>(task.Content).url;
        ...
        //    Task<StorageResponse<bool>> result = request<bool>("authenticate", body);
        ...
        //    Task<StorageResponse<bool>> result = request<bool>("isAuthenticated", body);
        //    return result.Result;
        //}
        ...
        //    Task<StorageResponse<IEnumerable<string>>> result = request<IEnumerable<string>>("listRoles", body);
        //    return result.Result;
        //}
        ...
        //    Task<StorageResponse<IEnumerable<Role>>> result = request<IEnumerable<Role>>("authenticate", body);
        //    return result.Result;
        //}
        ...
        /// <returns></returns>
        public Task<StorageResponse<T>> Get<T>(object id) where T : class
        {
        ...
        /// <returns></returns>
        public Task<StorageResponse<T>> Get<T>(object id, object secondary) where T : class
        {
        ...
        /// <returns></returns>
        public Task<StorageResponse<T>> Get<T>(DataKey id) where T : class
        {
        ...
        /// <returns></returns>
        public Task<StorageResponse<T>> Create<T>(T item) where T : class
        {
            var metadata = GetMetadata<T>();
        ...
        /// <param name="item">the item to save</param>
        /// <returns></returns>
        public Task<StorageResponse<T>> Update<T>(T item) where T : class
        {
            var metadata = GetMetadata<T>();
        ...
        /// <returns></returns>
        public Task<StorageResponse<T>> Delete<T>(T item) where T : class
        {
            var metadata = GetMetadata<T>();
        ...
        /// <returns></returns>
        public Task<StorageResponse<T>> Incr<T>(T item, string propertyName, int change = 1) where T : class
        {
            var metadata = GetMetadata<T>();
        ...
        /// <param name="change">the incremental change</param>
        /// <returns></returns>
        public Task<StorageResponse<T>> Decr<T>(T item, string propertyName, int change = 1) where T : class
        {
            var metadata = GetMetadata<T>();
        ...
        /// <returns></returns>
        public Task<StorageResponse<ItemList<T>>> Query<T>(ItemQueryRequest<T> query) where T : class
        {
            return Task.Run(() =>
            {
                var metadata = GetMetadata<T>();
                ...
                var task = Post<ItemList<T>>("queryItems", dto);
        ...
        /// <param name="query"></param>
        /// <returns></returns>
        public Task<StorageResponse<ItemList<T>>> List<T>(ItemListRequest<T> query) where T : class
        {
            return Task.Run(() =>
            {
                var metadata = GetMetadata<T>();
                ...
                var task = Post<ItemList<T>>("listItems", dto);
        ...
        /// <returns></returns>
        public Task<StorageResponse<TableMetadata>> GetTable(string table)
        {
            var request = new StorageRequest
            {
                applicationKey = ApplicationKey,
        ...
        /// <param name="table"></param>
        /// <returns></returns>
        public Task<StorageResponse<TableMetadata>> CreateTable(TableMetadata table)
        {
            var request = new StorageRequest
            {
                applicationKey = ApplicationKey,
        ...
        /// <param name="table"></param>
        /// <returns></returns>
        public Task<StorageResponse<TableMetadata>> UpdateTable(TableMetadata table)
        {
            var request = new StorageRequest
            {
                applicationKey = ApplicationKey,
        ...
        /// <param name="table"></param>
        /// <returns></returns>
        public Task<StorageResponse<TableMetadata>> DeleteTable(string table)
        {
            var request = new StorageRequest
            {
                applicationKey = ApplicationKey,
        ...
        /// <returns></returns>
        public Task<StorageResponse<TableList>> ListTables(int limit = 0, string startTable = null)
        {
            var request = new StorageRequest
            {
                applicationKey = ApplicationKey,
        ...
        /// </code>
        /// <returns></returns>
        public Task<StorageResponse<bool>> Authenticate(string authToken, string[] roles, int timeout = 1800)
        {
            AuthenticationToken = authToken;

            if (roles == null || roles.Length == 0)
                return new Task<StorageResponse<bool>>(new Exception("roles is required"));

            if (string.IsNullOrEmpty(AuthenticationToken))
                return new Task<StorageResponse<bool>>(new Exception("authToken is required"));
        ...
        /// </summary>
        /// <returns></returns>
        public Task<StorageResponse<bool>> IsAuthenticated()
        {
            if (string.IsNullOrEmpty(AuthenticationToken))
                return new Task<StorageResponse<bool>>(new StorageResponse<bool>(false));
        ...
        /// </summary>
        /// <returns></returns>
        public Task<StorageResponse<string[]>> ListRoles()
        {
            var body = new StorageRequest
            {
                applicationKey = ApplicationKey,
        ...
        /// </summary>
        /// <returns></returns>
        public Task<StorageResponse<Role[]>> GetRoles(string[] roles)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<StorageResponse<Role>> GetRole(string role)
        {
            var body = new StorageRequest
            {
                applicationKey = ApplicationKey,
